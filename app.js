...
function renderCharts(){const c=counts();Plotly.react('overallChart',[{values:[c.y,c.n],labels:['Sí','No'],type:'pie',hole:.68,textinfo:'percent',hovertemplate:'%{label}: %{value}<extra></extra>',marker:{colors:['#16a36a','#d94d5c']}}],plotLayout({margin:{l:12,r:12,t:15,b:40},annotations:[{text:`<b>${c.pct.toFixed(1)}%</b><br><span style="font-size:10px">cumplimiento</span>`,showarrow:false,font:{size:18}}]}),config)}
